...
function ImportarInner() {
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "20px 16px" }}>
      <h1 style={{ fontSize: 22, fontWeight: 800, margin: "0 0 4px" }}>Importar historial</h1>
      <p style={{ fontSize: 13, color: MUTED, margin: "0 0 16px" }}>Cargá un CSV con ventas pasadas. Los clientes se unifican por teléfono automáticamente.</p>
      ...
      <div style={box}>
        ...
        <button onClick={downloadTemplate} style={{ width: "auto", padding: "9px 14px", fontSize: 13, fontWeight: 600, color: SLATE, background: "#fff", border: `1px solid ${LINE}`, borderRadius: 10, cursor: "pointer" }}>Descargar plantilla</button>
      </div>
